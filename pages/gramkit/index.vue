<template>
  <div class="gramkit-page" :dir="locale === 'ar' ? 'rtl' : 'ltr'">
    ...
    <transition name="fade-slide">
      <div v-if="!isConnected" class="centered-wrap">
        <div class="connect-card">
          <div class="card-hero">
            <div class="hero-icon">
              <Icon name="mdi:telegram" size="34" />
            </div>
            <h1 class="card-title">KgramKit</h1>
                ...
                <div v-for="(s, i) in guideSteps" :key="i" class="guide-step">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      class="guide-link"
                    >
                      <Icon name="mdi:open-in-new" size="13" /> my.telegram.org
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div class="connect-card otp-card">
          <div class="card-hero">
            <div class="hero-icon purple">
              <Icon name="mdi:shield-lock-outline" size="34" />
            </div>
    ...
    <!-- Toast is handled by global plugin -->
  </div>
</template>
...
// ─── State ────────────────────────────────────────────────────────────────────
const step = ref("connect"); // 'connect' | 'otp' | 'dashboard'
